...
- [ ] `HUM-FR-011` Implement the governed fact-definition catalog.
- [ ] `HUM-FR-012` Implement typed, temporal, evidence-ready person facts.
- [ ] `HUM-FR-013` Implement contradictory facts, revisions, edges, evidence, and tags.
...
- [ ] `HUM-FR-022` Implement provider-neutral OpenAI-compatible analysis records.
...
- [ ] `HUM-FR-030` Implement the Task 13 cited AI analyst, progress, tool-trace, and provider/model disclosure beyond the implemented Task 12 authorized search and saved-query workbench.
...
- [ ] `HUM-NFR-010` Complete the whole-domain unit behavior matrix beyond Task 12 and Task 18 protected-contact/address normalization, temporal semantics, cursors, permissions, replay, and UI-control coverage.
